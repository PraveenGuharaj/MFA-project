...
@Component({
  selector: 'app-master-data-add-currency',
  imports: [
    CommonModule,
    MatSelectModule,
    MatInputModule,
  ...
  templateUrl: './master-data-add-currency.html',
  styleUrl: './master-data-add-currency.scss',
})
export class MasterDataAddCurrency {
