...
@Component({
  selector: 'app-master-data-add-language',
  imports: [
    CommonModule,
    MatSelectModule,
    MatInputModule,
  ...
  templateUrl: './master-data-add-language.html',
  styleUrl: './master-data-add-language.scss',
})
export class MasterDataAddLanguage {
