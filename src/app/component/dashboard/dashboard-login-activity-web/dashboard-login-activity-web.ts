...
@Component({
  selector: 'app-dashboard-login-activity-web',
  imports: [
    CommonModule,
    MatCardModule,
    BaseChartDirective,
  ...
  templateUrl: './dashboard-login-activity-web.html',
  styleUrl: './dashboard-login-activity-web.scss',
})
export class DashboardLoginActivityWeb {
      ...
      const lineChart: any = new Chart(ctxLineChart, {
        ...
        data: {
          ...
          datasets: [
            ...
            // },
            {
              data: [6000, 4500, 4000, 6200, 8500], // Updated web data
