...
@Component({
  selector: 'app-dashboard-user-overview-mobile',
  imports: [
    CommonModule,
    // BaseChartDirective,
    MatCardModule,
  ...
  templateUrl: './dashboard-user-overview-mobile.html',
  styleUrl: './dashboard-user-overview-mobile.scss',
})
export class DashboardUserOverviewMobile {
