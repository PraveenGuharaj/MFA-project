...
@Component({
  selector: 'app-dashboard-session-metrics',
  imports: [
      CommonModule,
    MatCardModule,
    BaseChartDirective,
  ...
  templateUrl: './dashboard-session-metrics.html',
  styleUrl: './dashboard-session-metrics.scss',
})
export class DashboardSessionMetrics {
