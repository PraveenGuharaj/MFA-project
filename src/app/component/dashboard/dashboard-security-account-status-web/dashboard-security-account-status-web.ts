...
@Component({
  selector: 'app-dashboard-security-account-status-web',
  imports: [
    CommonModule,
    MatCardModule,
    BaseChartDirective,
  ...
  templateUrl: './dashboard-security-account-status-web.html',
  styleUrl: './dashboard-security-account-status-web.scss',
})
export class DashboardSecurityAccountStatusWeb {
