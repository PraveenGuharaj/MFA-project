...
@Component({
  selector: 'app-dashboard-login-activity-mobile',
  imports: [
    CommonModule,
    MatCardModule,
    BaseChartDirective,
  ...
  templateUrl: './dashboard-login-activity-mobile.html',
  styleUrl: './dashboard-login-activity-mobile.scss',
})
export class DashboardLoginActivityMobile {
