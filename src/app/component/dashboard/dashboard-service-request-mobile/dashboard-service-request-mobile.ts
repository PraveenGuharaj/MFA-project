...
@Component({
  selector: 'app-dashboard-service-request-mobile',
  imports: [
    CommonModule,
    CommonModule,
    MatCardModule,
  ...
  templateUrl: './dashboard-service-request-mobile.html',
  styleUrl: './dashboard-service-request-mobile.scss',
})
export class DashboardServiceRequestMobile {
