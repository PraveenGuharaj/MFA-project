...
@Component({
  selector: 'app-dashboard-session-metrics-mobile',
  imports: [   
    CommonModule,
    MatCardModule,
    BaseChartDirective,
    MatIconModule],
  templateUrl: './dashboard-session-metrics-mobile.html',
  styleUrl: './dashboard-session-metrics-mobile.scss',
})
export class DashboardSessionMetricsMobile {
