...
@Component({
  selector: 'app-dashboard-geographics-chart',
  imports: [
    CommonModule,
    CommonModule,
    MatCardModule,
  ...
  templateUrl: './dashboard-geographics-chart.html',
  styleUrl: './dashboard-geographics-chart.scss',
})
export class DashboardGeographicsChart {
