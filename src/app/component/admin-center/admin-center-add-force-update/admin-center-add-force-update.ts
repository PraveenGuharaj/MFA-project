...
@Component({
  selector: 'app-admin-center-add-force-update',
  imports: [
    CommonModule,
    MatSelectModule,
    MatInputModule,
  ...
  templateUrl: './admin-center-add-force-update.html',
  styleUrl: './admin-center-add-force-update.scss',
})
export class AdminCenterAddForceUpdate {
