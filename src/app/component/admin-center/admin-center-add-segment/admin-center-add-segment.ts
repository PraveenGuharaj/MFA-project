...
@Component({
  selector: 'app-admin-center-add-segment',
  imports: [
    CommonModule,
    MatSelectModule,
    MatInputModule,
  ...
  templateUrl: './admin-center-add-segment.html',
  styleUrl: './admin-center-add-segment.scss',
})
export class AdminCenterAddSegment {
