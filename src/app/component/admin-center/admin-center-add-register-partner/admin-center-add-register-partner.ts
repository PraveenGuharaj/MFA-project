...
@Component({
  selector: 'app-admin-center-add-register-partner',
  imports: [
    CommonModule,
    MatSelectModule,
    MatInputModule,
  ...
  templateUrl: './admin-center-add-register-partner.html',
  styleUrl: './admin-center-add-register-partner.scss',
})
export class AdminCenterAddRegisterPartner {
