...
@Component({
  selector: 'app-admin-center-add-terms-condition',
  imports: [
    CommonModule,
    MatSelectModule,
    MatInputModule,
  ...
  templateUrl: './admin-center-add-terms-condition.html',
  styleUrl: './admin-center-add-terms-condition.scss',
})
export class AdminCenterAddTermsCondition {
