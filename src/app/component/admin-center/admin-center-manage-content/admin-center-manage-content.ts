...
@Component({
  selector: 'app-admin-center-manage-content',
  imports: [
    CommonModule,
    MatIconModule
  ],
  templateUrl: './admin-center-manage-content.html',
  styleUrl: './admin-center-manage-content.scss',
})
export class AdminCenterManageContent {
