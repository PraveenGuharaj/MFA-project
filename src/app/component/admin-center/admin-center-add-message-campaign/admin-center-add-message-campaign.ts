...
@Component({
  selector: 'app-admin-center-add-message-campaign',
  imports: [
    CommonModule,
    MatSelectModule,
    MatInputModule,
  ...
  templateUrl: './admin-center-add-message-campaign.html',
  styleUrl: './admin-center-add-message-campaign.scss',
})
export class AdminCenterAddMessageCampaign {
